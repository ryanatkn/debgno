...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `config.ts`       | URLs (`BASE_URL`, `LOCAL_URL`), `MOZILLA_KEY_HASH`, `GRUB_TIMEOUT`, `PACKAGES`, `UNWANTED_PACKAGES`, `VERIFY_EXTRA_PACKAGES`, `DOWNLOAD_FILES`, shared paths (`STAGING_DIR`, `POST_INSTALL_LOG`, `POST_INSTALL_MARKER`, `MOZILLA_KEY_PATH`, `FIREFOX_POLICIES_PATH`), types (`DebgnoConfig`, `DownloadFile`, `FileHashes`) | —                                            |
